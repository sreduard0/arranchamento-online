                ...
                <form id="form-visitor">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input id="edit_name_visitor" name="edit_name_visitor" type="text" class="form-control"
                    ...
                    <div class="row">
                        <div class="col form-group ">
                            ...
                            <input type="text" class="form-control" data-inputmask="'mask': ['999.999.999-99']"
                                inputmode="text" data-mask="" id="edit_cpf" name="edit_cpf" placeholder="CPF" value="">
                        </div>
                        <div class="col form-group ">
                            <label for="edit_phone">Telefone</label>
                            <input type="text" class="form-control" data-inputmask="'mask': ['(99) 9 9999-9999']"
                                inputmode="text" data-mask="" id="edit_phone" name="edit_phone" placeholder="Telefone"
                                value="">
                        </div>
                    </div>
            </div>
